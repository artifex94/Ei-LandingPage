      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            { icon: <Shield className="w-8 h-8 text-white" />, title: "Equipos Certificados", desc: "Trabajamos únicamente con marcas líderes en seguridad electrónica y domótica.", color: "bg-slate-800" }
          ].map((feature, idx) => (
