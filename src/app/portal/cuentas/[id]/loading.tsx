export default function CuentaLoading() {
  return (
    <div className="space-y-8" aria-busy="true" aria-label="Cargando…">
      ...
      {/* panel estado */}
      <div className="h-20 bg-industrial-800 rounded-lg border border-industrial-700 animate-pulse" />
      ...
      <div>
        ...
        <div className="space-y-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-industrial-800 rounded-lg border border-industrial-700 px-5 py-4 flex items-center justify-between animate-pulse">
